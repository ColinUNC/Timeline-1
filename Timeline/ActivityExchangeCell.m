...
@implementation ActivityExchangeCell
              ...
              andImagesCache:(ImagesCache*)imagesCache
{
    ...
    CGRect coverImageFrame = self.coverImage.frame;
    ...
    commentViewFrame.origin.y = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f+self.likeButton.frame.size.height+5.0f+likesHeight+self.coverImage.frame.size.height+5.0f;
    descriptionLabelFrame.size.height = descriptionLabelSize.height;
    coverImageFrame.origin.y = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f;
    likeButtonFrame.origin.y = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f+self.coverImage.frame.size.height+5.0f;
    commentButtonFrame.origin.y = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f+self.coverImage.frame.size.height+5.0f;
    likesViewFrame.origin.y = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f+self.likeButton.frame.size.height+5.0f+self.coverImage.frame.size.height+5.0f;
    [self.descriptionLabel setFrame:descriptionLabelFrame];
    [self.coverImage setFrame:coverImageFrame];
    ...
    float containerHeight = self.descriptionLabel.frame.origin.y+descriptionLabelSize.height+5.0f+self.likeButton.frame.size.height+5.0f+likesHeight+commentsHeight+5.0f+self.coverImage.frame.size.height+5.0f;
    ...
    self.coverImage.image = [imagesCache imageInUIImageView:self.coverImage
                                               forTableView:tv
                                                atIndexPath:ip
                                                    withURL:[params objectForKey:CSActivityKeyParamsCover]
                                                    andType:CSImageTypeActivityCover];
